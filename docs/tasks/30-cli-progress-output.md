...
[00:02:30] "This is what I heard..." (partial)
```

- Status line: spinner + elapsed time + format + source info
- Partial segment line: timestamp + text + "(partial)" marker
- Partial segments overwrite in-place (carriage return without newline)
